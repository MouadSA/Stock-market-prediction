...
RAW = pd.read_csv( 'NVDA_Stock_Data.csv' )
# Extraction des colonnes 'date' et 'close'
RAW = ( RAW[ [ 'date', 'close' ] ] ).drop( 'date', axis = 1 )
RAW = RAW.reset_index( drop = True )
# Conversion en float32 et mise à l'échelle Min-Max
...
# Import des bibliothèques pour le modèle
...
# Définition du chemin pour sauvegarder les modèles
...
# Calcul du RMSE sur les ensembles d'entraînement et de test
